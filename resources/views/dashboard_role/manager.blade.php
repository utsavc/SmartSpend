			...
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						...
						Expenses Submitted</div>
						<div class="h5 mb-0 font-weight-bold text-gray-800">{{$manager_pendings}}</div>
					</div>
					<div class="col-auto">
			...
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						...
						<div class="h5 mb-0 font-weight-bold text-gray-800 text-white">{{$approveds}}</div>
					</div>
					<div class="col-auto">
